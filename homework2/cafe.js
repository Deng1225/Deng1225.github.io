window.onload = function (){
    ...
    document.getElementById("DQA1").onclick=function(){
    ...
    document.getElementById("DQA2").onclick=function(){
    var options=document.createElement("option");
    ...
    document.getElementById("DQA3").onclick=function(){
    var options=document.createElement("option");
    ...
    document.getElementById("DQA4").onclick=function(){
    var options=document.createElement("option");
    ...
    document.getElementById("DQA5").onclick=function(){
    var options=document.createElement("option");
    ...
    document.getElementById("DQA6").onclick=function(){
    var options=document.createElement("option");
